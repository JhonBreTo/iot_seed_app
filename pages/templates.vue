          ...
          <div class="col-6">
            ...
            >
              <el-option
                class="text-dark"
                value="numberchart"
                label="Gráfico de Valores Numéricos INPUT <-"
              >
              </el-option>
              <el-option
                class="text-dark"
            ...
            <div v-if="widgetType == 'numberchart'">
              ...
              <base-input
                ...
                label="Intervalo Previo en el Gráfico (mins)"
                type="number"
              ></base-input>
  ...
  methods: {
    ...
    async deleteTemplate(template) {
      ...
      try {
        ...
        console.log(res.data)
        if (res.data.status == "fail" && res.data.error == "Plantilla en uso") {
          this.$notify({
            type: "danger",
            icon: "tim-icons icon-alert-circle-exc",
            message: template.name + " está en uso. Primero remueva el dispositivo asociado a la plantilla!"
          });
