  ...
  <div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <card v-if="$store.state.devices.length > 0 ">
          ...
          <div slot="header">
            <h4 class="card-title">Crear Nueva Regla de Alarma {{selectedWidgetIndex}}</h4>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-3">
              <base-input label="Tiempo de Disparo de Regla" v-model="newRule.triggerTime" type="number"></base-input>
            </div>
        ...
        <card v-else>
          Necesita seleccionar un dispositivo para crear una Alarma
        </card>
      </div>
    </div>
    ...
    <div class="row" v-if="$store.state.devices.length > 0">
      <div class="col-sm-12">
        <card>
          <div slot="header">
            <h4 class="card-title">Reglas de Alarma</h4>
          </div>
    ...
    createNewRule() {
      ...
      if (this.newRule.condition == null) {
        this.$notify({
          type: "warning",
          icon: "tim-icons icon-alert-circle-exc",
          message: " Condicion debe ser seleccionado"
        });
        return;
      }
