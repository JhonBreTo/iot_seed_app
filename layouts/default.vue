  ...
  methods: {
    ...
    async startMqttClient() {
      ...
      this.client.on('connect', () => {
        console.log('Conexion satisfecha!');
        //SDATA SUBSCRIBE
        this.client.subscribe(deviceSubscribeTopic, {qos:0}, (err) => {
          if (err){
            console.log("Error en subscripcion");
            return;
          }
          console.log("Subscripcion satisfecha");
      ...
      this.client.on('message', (topic, message) => {
        console.log("Mensaje del topico" + topic + " -> ");
